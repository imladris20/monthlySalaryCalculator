...
function getInsuranceDeduction(nominalSalary, isPartTime = false) {
  const brackets = isPartTime
    ? [...PART_TIME_INSURANCE_BRACKETS, ...INSURANCE_BRACKETS]
    : INSURANCE_BRACKETS;
  ...
  // 預設最高級距
  if (nominalSalary >= brackets[brackets.length - 1].salary) {
